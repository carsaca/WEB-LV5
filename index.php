...
<section class="container d-flex flex-column  align-items-center mb-4">
    <h1>CFC 3</h1>
    <h2 id="gameinfo">Choose your cat</h2>
</section>
...
<div class="row">
                ...
                <div class="row fighter-list">
                    ...
                    foreach($cats as $cat){ ?>
                        <div class="col-md-4 mb-1">
                            ...
                            <?php 
                            echo '<img src="'.$cat['image'].'" alt="Figter Box 2" width="150" height="150"/>';
                            ?>
                            </div>
                            <button id="edit" class="btn btn-light" data-info='{"id": <?php echo $cat['id'] ?>}'>Edit</button>
                        </div>
                    <?php } ?>
                </div>
            </div>
    ...
    <div class="col-2 d-flex flex-column align-items-center">
        ...
        <button id="addFighter" class="btn btn-secondary mb-4">Add new fighter</button>
    </div>
